 ...
 */
class LightFireCharacter(override var locationInBlock: Point) : AbstractCharacter() {
    // it performs an action once a second
    private var nextAction = System.currentTimeMillis() + 10
    ...
    override fun tick(block: GridWorldBlock): List<GridWorldEvent> {
        ...
        if (System.currentTimeMillis() > nextAction) {
            nextAction = System.currentTimeMillis() + 10
